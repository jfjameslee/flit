...
```
curl -fsSL https://jfjameslee.github.io/flit/flit.gpg \
    | sudo tee /etc/apt/keyrings/flit.gpg > /dev/null

echo "deb [signed-by=/etc/apt/keyrings/flit.gpg] \
  https://jfjameslee.github.io/flit stable main" \
  | sudo tee /etc/apt/sources.list.d/flit.list
